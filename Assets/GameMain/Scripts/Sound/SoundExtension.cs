...
namespace StarForce
{
    public static class SoundExtension
    {
        ...
        public static int? PlayMusic(this SoundComponent soundComponent, int musicId, object userData = null)
        {
            ...
            s_MusicSerialId = soundComponent.PlaySound(AssetUtility.GetMusicAsset(drMusic.AssetName), "Music", 0, playSoundParams, null, userData);
        ...
        public static int? PlayUISound(this SoundComponent soundComponent, int uiSoundId, object userData = null)
        {
            ...
            return soundComponent.PlaySound(AssetUtility.GetUISoundAsset(drUISound.AssetName), "UISound", 0, playSoundParams, userData);
        }
