...
namespace LogicShared.LiteNetLib.Utils
{
    ...
    public class NetDataReader
    {
        ...
        protected int _position;    //有效数据起始位置
        protected int _dataSize;    //数据长度
        private int _offset;        //有效数据相对起始位置的偏移量
        ...
        /// <summary>
        /// 从start索引开始填充destination数组，填充数量是count
        /// </summary>
        ...
        /// <summary>
        /// 从0开始填充destination数组，填充数量是count
        /// </summary>
        /// <param name="destination"></param>
        /// <param name="count"></param>
