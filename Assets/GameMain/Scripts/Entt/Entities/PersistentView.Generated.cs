...
namespace Entt.Entities
{
        ...
        where TEntityKey: IEntityKey
    {
        ...
        public void Apply(ViewDelegates.ApplyIn0Out1<TEntityKey, T1 > bulk)
        {
        ...
        void ApplyParallel(ViewDelegates.ApplyIn0Out1<TEntityKey, T1 > bulk)
        {
            var p = EntityKeyListPool<TEntityKey>.Reserve(this);
            try
            {
        ...
        void ApplyMany(RawList<TEntityKey> p, ViewDelegates.ApplyIn0Out1<TEntityKey, T1> bulk, int fromInclusive, int toExclusive)
        {
        ...
        void ApplyOne(ViewDelegates.ApplyIn0Out1<TEntityKey, T1 > bulk, TEntityKey ek)
        {
        ...
        void ApplyParallelWithContext<TContext>(TContext context, ViewDelegates.ApplyWithContextIn0Out1<TEntityKey, TContext, T1> bulk)
        {
            var p = EntityKeyListPool<TEntityKey>.Reserve(this);
            try
            {
        ...
        void ApplyManyWithContext<TContext>(RawList<TEntityKey> p, 
                                            (TContext context, ViewDelegates.ApplyWithContextIn0Out1<TEntityKey, TContext, T1> bulk) b, 
        ...
        void ApplyOneWithContext<TContext>(TContext context, ViewDelegates.ApplyWithContextIn0Out1<TEntityKey, TContext, T1> bulk, TEntityKey ek)
        {
            // declare default values for each query
            T1 d1 = default;
            ref var r1 = ref poolT1.TryGetModifiableRef(ek, ref d1, out var s1); if (!s1) return;
        ...
        void ApplyParallel(ViewDelegates.Apply<TEntityKey, T1 > bulk)
        {
            var p = EntityKeyListPool<TEntityKey>.Reserve(this);
            try
            {
        ...
        void ApplyMany(RawList<TEntityKey> p, ViewDelegates.Apply<TEntityKey, T1> bulk, int fromInclusive, int toExclusive)
        {
            var data = p.UnsafeData;
            for (int i = fromInclusive; i < toExclusive; i += 1)
            {
        ...
        void ApplyParallelWithContext<TContext>(TContext context, ViewDelegates.ApplyWithContext<TEntityKey, TContext, T1> bulk)
        {
            var p = EntityKeyListPool<TEntityKey>.Reserve(this);
            try
            {
        ...
        void ApplyManyWithContext<TContext>(RawList<TEntityKey> p, 
                                            (TContext context, ViewDelegates.ApplyWithContext<TEntityKey, TContext, T1> bulk) b, 
                                            int fromInclusive, int toExclusive)
        {
            var (context, bulk) = b;
            var data = p.UnsafeData;
