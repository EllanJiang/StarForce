...
namespace D11.Pjson {
  ...
  /// <summary>Holder for reflection information generated from WeaponPersistenceConfigInstantC4BombData.proto</summary>
  public static partial class WeaponPersistenceConfigInstantC4BombDataReflection {

    #region Descriptor
    /// <summary>File descriptor for WeaponPersistenceConfigInstantC4BombData.proto</summary>
    public static pbr::FileDescriptor Descriptor {
      get { return descriptor; }
    }
    private static pbr::FileDescriptor descriptor;

    static WeaponPersistenceConfigInstantC4BombDataReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "Ci5XZWFwb25QZXJzaXN0ZW5jZUNvbmZpZ0luc3RhbnRDNEJvbWJEYXRhLnBy",
            "b3RvEglEMTEuUGpzb24aKldlYXBvblBlcnNpc3RlbmNlQ29uZmlnQ29tcG9u",
            "ZW50RGF0YS5wcm90byKHBwooV2VhcG9uUGVyc2lzdGVuY2VDb25maWdJbnN0",
            "YW50QzRCb21iRGF0YRIdChVDNEJvbWJJbml0aWF0ZVNvdW5kRnAYASABKAkS",
            "HQoVQzRCb21iSW5pdGlhdGVTb3VuZFRwGAIgASgJEiIKGkNsb3NlQzRCb21i",
            "SW5pdGlhdGVTb3VuZEZwGAMgASgJEiIKGkNsb3NlQzRCb21iSW5pdGlhdGVT",
            "b3VuZFRwGAQgASgJEhgKEEM0Qm9tYktleVByZXNzRnAYBSABKAkSIAoYQzRC",
            "b21iRGlzYXJtU3RhcnRTb3VuZEZwGAYgASgJEiAKGEM0Qm9tYkRpc2FybVN0",
            "YXJ0U291bmRUcBgHIAEoCRIhChlDNEJvbWJEaXNhcm1GaW5pc2hTb3VuZEZw",
            "GAggASgJEiEKGUM0Qm9tYkRpc2FybUZpbmlzaFNvdW5kVHAYCSABKAkSJAoc",
            "U3RvcEM0Qm9tYkRpc2FybVN0YXJ0U291bmRGcBgKIAEoCRIkChxTdG9wQzRC",
            "b21iRGlzYXJtU3RhcnRTb3VuZFRwGAsgASgJEiUKHVN0b3BDNEJvbWJEaXNh",
            "cm1GaW5pc2hTb3VuZEZwGAwgASgJEiUKHVN0b3BDNEJvbWJEaXNhcm1GaW5p",
            "c2hTb3VuZFRwGA0gASgJEhoKEkM0Qm9tYkV4cGxvZGVTb3VuZBgOIAEoCRIl",
            "Ch1DNEJvbWJFeHBsb2RlVHJpZ2dlclRyaXBTb3VuZBgPIAEoCRIhChlDNEJv",
            "bWJFeHBsb2RlV2FybmluZ1NvdW5kGBAgASgJEhwKFEM0Qm9tYlBsYW50QmVl",
            "cFNvdW5kGBEgASgJEiMKG0M0Qm9tYlBsYW50QmVlcEludGVydmFsVGltZRgS",
            "IAEoAhIcChRDNEJvbWJQbGFudEFuaUxlbmd0aBgTIAEoAhIiChpDNEJvbWJJ",
            "bml0aWF0ZUZpbmlzaGVkVGltZRgUIAEoAhIjChtDNEJvbWJEaXNhcm1GaW5p",
            "c2hTb3VuZFRpbWUYFSABKAISJAocQzRCb21iRXhwbG9kZVRyaWdnZXJUcmlw",
            "VGltZRgWIAEoAhIgChhDNEJvbWJFeHBsb2RlV2FybmluZ1RpbWUYFyABKAIS",
            "PwoGcGFyZW50GBggASgLMi8uRDExLlBqc29uLldlYXBvblBlcnNpc3RlbmNl",
            "Q29uZmlnQ29tcG9uZW50RGF0YWIGcHJvdG8z"));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::D11.Pjson.WeaponPersistenceConfigInstantC4BombData), global::D11.Pjson.WeaponPersistenceConfigInstantC4BombData.Parser, new[]{ "C4BombInitiateSoundFp", "C4BombInitiateSoundTp", "CloseC4BombInitiateSoundFp", "CloseC4BombInitiateSoundTp", "C4BombKeyPressFp", "C4BombDisarmStartSoundFp", "C4BombDisarmStartSoundTp", "C4BombDisarmFinishSoundFp", "C4BombDisarmFinishSoundTp", "StopC4BombDisarmStartSoundFp", "StopC4BombDisarmStartSoundTp", "StopC4BombDisarmFinishSoundFp", "StopC4BombDisarmFinishSoundTp", "C4BombExplodeSound", "C4BombExplodeTriggerTripSound", "C4BombExplodeWarningSound", "C4BombPlantBeepSound", "C4BombPlantBeepIntervalTime", "C4BombPlantAniLength", "C4BombInitiateFinishedTime", "C4BombDisarmFinishSoundTime", "C4BombExplodeTriggerTripTime", "C4BombExplodeWarningTime", "Parent" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #region Messages
  public sealed partial class WeaponPersistenceConfigInstantC4BombData : pb::IMessage<WeaponPersistenceConfigInstantC4BombData> {
    private static readonly pb::MessageParser<WeaponPersistenceConfigInstantC4BombData> _parser = new pb::MessageParser<WeaponPersistenceConfigInstantC4BombData>(() => new WeaponPersistenceConfigInstantC4BombData());
    private pb::UnknownFieldSet _unknownFields;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public static pb::MessageParser<WeaponPersistenceConfigInstantC4BombData> Parser { get { return _parser; } }

    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public static pbr::MessageDescriptor Descriptor {
      get { return global::D11.Pjson.WeaponPersistenceConfigInstantC4BombDataReflection.Descriptor.MessageTypes[0]; }
    }
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public WeaponPersistenceConfigInstantC4BombData() {
      OnConstruction();
    }
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public WeaponPersistenceConfigInstantC4BombData(WeaponPersistenceConfigInstantC4BombData other) : this() {
      ...
      c4BombPlantBeepSound_ = other.c4BombPlantBeepSound_;
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public WeaponPersistenceConfigInstantC4BombData Clone() {
      return new WeaponPersistenceConfigInstantC4BombData(this);
    }
    ...
    public const int C4BombDisarmStartSoundFpFieldNumber = 6;
    ...
    public const int C4BombDisarmStartSoundTpFieldNumber = 7;
    ...
    public const int C4BombDisarmFinishSoundFpFieldNumber = 8;
    ...
    public const int C4BombDisarmFinishSoundTpFieldNumber = 9;
    ...
    public const int StopC4BombDisarmStartSoundFpFieldNumber = 10;
    ...
    public const int StopC4BombDisarmStartSoundTpFieldNumber = 11;
    ...
    public const int StopC4BombDisarmFinishSoundFpFieldNumber = 12;
    ...
    public const int StopC4BombDisarmFinishSoundTpFieldNumber = 13;
    ...
    public const int C4BombExplodeSoundFieldNumber = 14;
    ...
    public const int C4BombExplodeTriggerTripSoundFieldNumber = 15;
    ...
    public const int C4BombExplodeWarningSoundFieldNumber = 16;
    ...
    /// <summary>Field number for the "C4BombPlantBeepSound" field.</summary>
    public const int C4BombPlantBeepSoundFieldNumber = 17;
    private string c4BombPlantBeepSound_ = "";
    /// <summary>
    /// C4 安装后的beep 
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public string C4BombPlantBeepSound {
      get { return c4BombPlantBeepSound_; }
      set {
        c4BombPlantBeepSound_ = pb::ProtoPreconditions.CheckNotNull(value, "value");
      }
    }

    /// <summary>Field number for the "C4BombPlantBeepIntervalTime" field.</summary>
    public const int C4BombPlantBeepIntervalTimeFieldNumber = 18;
    ...
    public const int C4BombPlantAniLengthFieldNumber = 19;
    ...
    public const int C4BombInitiateFinishedTimeFieldNumber = 20;
    ...
    public const int C4BombDisarmFinishSoundTimeFieldNumber = 21;
    ...
    public const int C4BombExplodeTriggerTripTimeFieldNumber = 22;
    ...
    public const int C4BombExplodeWarningTimeFieldNumber = 23;
    ...
    public const int ParentFieldNumber = 24;
    ...
    public override bool Equals(object other) {
      return Equals(other as WeaponPersistenceConfigInstantC4BombData);
    }

    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public bool Equals(WeaponPersistenceConfigInstantC4BombData other) {
      ...
      if (C4BombPlantBeepSound != other.C4BombPlantBeepSound) return false;
    ...
    public override int GetHashCode() {
      ...
      if (C4BombPlantBeepSound.Length != 0) hash ^= C4BombPlantBeepSound.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (C4BombPlantBeepSound.Length != 0) {
        output.WriteRawTag(138, 1);
        output.WriteString(C4BombPlantBeepSound);
      }
    ...
    public int CalculateSize() {
      ...
      if (C4BombExplodeTriggerTripSound.Length != 0) {
        size += 1 + pb::CodedOutputStream.ComputeStringSize(C4BombExplodeTriggerTripSound);
      }
      if (C4BombExplodeWarningSound.Length != 0) {
        size += 2 + pb::CodedOutputStream.ComputeStringSize(C4BombExplodeWarningSound);
      }
      if (C4BombPlantBeepSound.Length != 0) {
        size += 2 + pb::CodedOutputStream.ComputeStringSize(C4BombPlantBeepSound);
      }
      if (C4BombPlantBeepIntervalTime != 0F) {
        size += 2 + 4;
      }
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    public void MergeFrom(WeaponPersistenceConfigInstantC4BombData other) {
      if (other == null) {
        return;
      }
      ...
      if (other.C4BombPlantBeepSound.Length != 0) {
        C4BombPlantBeepSound = other.C4BombPlantBeepSound;
      }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 138: {
            C4BombPlantBeepSound = input.ReadString();
            break;
          }
          case 149: {
